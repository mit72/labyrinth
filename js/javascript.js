...
document.addEventListener("DOMContentLoaded", function(event) {
    ...
    const img = new Image();
    img.src = 'img/cd_007_small.gif'; // Replace with the actual image path
    ...
    function moveImage() {
        ...
        if (x < resitev.length - 2) {
            ...
            ctx.drawImage(img, vmesx - img.width / 2, vmesy - img.height / 2); // Draw the image at the calculated position
